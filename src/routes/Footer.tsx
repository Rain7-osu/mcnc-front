  ...
  return (
    <FooterWrapper>
      ...
      <div className="footer-power">
        powered by&nbsp;
        <a href="https://space.bilibili.com/29146366" target="_blank" rel="noreferrer">Myukee_</a>&nbsp;
        <a href="https://osu.ppy.sh/users/9787146" target="_blank" rel="noreferrer">(osu id: Myukee)</a>
        ,&nbsp;
